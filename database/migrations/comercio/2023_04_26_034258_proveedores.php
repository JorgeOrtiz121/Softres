...
class Proveedores extends Migration
{
    ...
    public function up()
    {
        Schema::connection('tenant')->create('proveedores', function (Blueprint $table) {
            ...
            $table->unsignedInteger('id_categoria')->nullable()->comment('llave foranea tabla categoria_proveedor');
            $table->unsignedInteger('id_tipos')->nullable()->comment('llave foranea tabla tipo_proveedor');
            ...
            $table->foreign('id_categoria')->references('id')->on('categoria_proveedor');
            $table->foreign('id_tipos')->references('id')->on('tipo_proveedor');
