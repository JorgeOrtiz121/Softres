                ...
                <div class="x_content">
                  <table id="TableInfoCuentasEmail">
                    ...
                    <tr>
                      <td>
                        <div class="form-group">
                          <input type="button" id="TestMail" value="Enviar email de prueba" class="TestMail">
                        </div>
                      </td>
                    </tr>
                  </table>
...
<div id="ModalTestMail" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
  <div class="modal-dialog modal-lg">
      <div class="modal-content">
          <div class="modal-header">
              <h4 class="modal-title" id="myModalLabel">Enviar Email de prueba</h4>
          ...
          <div class="modal-body">
              <div class="row">
                  <div class="col-sm-6">
                      <div class="form-group">
                          <label class="col-form-label label-align">Ingrese una dirección de correo electrónico</label>
                          <input type="email" id="ModalMailSend" name="ModalMailSend" class="form-control">
                      </div>
                  </div>
              </div>
          </div>
          <div class="modal-footer">
              ...
              <input type="button" value="Aceptar" id="Aceptar" class="btn btn-success SendTestMail">
          </div>
      </div>
  </div>
</div>
...
<script>
  ...
  $(document).on('click', '.TestMail', function(event){
    $('#ModalMailSend').val('');
    $("#ModalTestMail").modal('show');
  });

  // {{-- Enviar correo --}}
  $('#ModalTestMail .SendTestMail').click(function(){
    var routeSend = "{{asset('SendTestMail')}}";
    var token = $("#token").val();
    var formData = new FormData();
    formData.append("email", $("#ModalMailSend").val());
