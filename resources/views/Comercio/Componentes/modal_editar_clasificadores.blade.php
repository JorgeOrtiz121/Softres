<div class="modal" id="modalEditar" tabindex="-1" zIndex="1040" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="frmConfirmarEditar">
                <input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}">
                <div class="modal-body">
                    <div class="form-group">
                        <div class="col-sm{{$columna}}">
                            <label for="nombreClasificador" class="" >{{$descripcion}}</label>
                            <input type="text" class="form-control" name="nombreNuevoClasificador" id="nombreNuevoClasificador" value="" required>
                        </div>
                        <div class="col-sm-4">
                            {{$abreviatura}}
                        </div>
