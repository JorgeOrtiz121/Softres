...
// ###### INICIO ADMINISTRACION ######
    ...
    Route::post('parametros_generales_guardar', 'Comercio\Administracion\ParametrosGeneralesController@parametros_generales_guardar');
        ...
        // Email
        Route::post('SendTestMail', 'Comercio\Administracion\ParametrosGeneralesController@SendTestMail');
...
// ###### INVENTARIO ######
    ...
    Route::get('comercio/inventario/clasificadores', 'Comercio\Inventario\InventarioController@clasificadores')->name('clasificadores');
        ...
        Route::get('GetCustomCode', 'Comercio\Inventario\InventarioController@GetCustomCode')->name('GetCustomCode');
// ###### Fin Iventarios ######
...
// ###### Inicio Proveedores ######
    ...
    Route::get('comercio/buscar-proveedores', 'Comercio\Proveedores\ProveedoresController@FindProveedores');

    // Category
    Route::get('comercio/GetCategory/{option?}/{id?}', 'Comercio\Proveedores\ProveedoresController@GetCategory')->name('GetCategory');
    Route::post('comercio/Category/', 'Comercio\Proveedores\ProveedoresController@AdminCategory');

    // SupplierType
    Route::get('comercio/GetSupplierType/{option?}/{id?}', 'Comercio\Proveedores\ProveedoresController@GetSupplierType')->name('GetSupplierType');
    Route::post('comercio/SupplierType/', 'Comercio\Proveedores\ProveedoresController@AdminSupplierType');
// ###### Fin Proveedores ######

// ###### Inicio Compras ######
    // Registrar compras
    Route::get('comercio/panel_compras', 'Comercio\Compras\ComprasController@panel_compras')->name('panel_compras');
    Route::get('comercio/registrar_compra', 'Comercio\Compras\ComprasController@registrar_compra')->name('RegistrarCompra');
        // TiposComprasVarias
        Route::get('comercio/tipos_compras_varias/{option?}/{id?}', 'Comercio\Compras\ComprasController@GetTiposComprasVarias')->name('GetTiposComprasVarias');
        Route::post('comercio/tipos_compras_varias/', 'Comercio\Compras\ComprasController@AdminTiposComprasVarias')->name('AdminTiposComprasVarias');

        // SustentoTributario
        Route::get('comercio/sustento_tributario/{option?}/{id?}', 'Comercio\Compras\ComprasController@GetSustentoTributario')->name('GetSustentoTributario');
        Route::post('comercio/sustento_tributario/', 'Comercio\Compras\ComprasController@AdminSustentoTributario')->name('AdminSustentoTributario');

        // DocumentoAutorizado
        Route::get('comercio/documento_autorizado/{option?}/{id?}', 'Comercio\Compras\ComprasController@GetDocumentoAutorizado')->name('GetDocumentoAutorizado');
        Route::post('comercio/documento_autorizado/', 'Comercio\Compras\ComprasController@AdminDocumentoAutorizado')->name('AdminDocumentoAutorizado');
 
        Route::post('comercio/import_xml/', 'Comercio\Compras\ComprasController@ImportXML')->name('ImportXML');
