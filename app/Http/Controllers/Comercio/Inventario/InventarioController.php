...
class InventarioController extends Controller
{
    ...
    // Obtener codigo personalizado de articulo
    public function GetCustomCode(){
        if( request()->ajax() ){
            $articulos = Articulos::whereRaw("codigo REGEXP '^[0-9]'")->orderBy('codigo','ASC')->get()->last();        

            return (isset($articulos->codigo)) ? $articulos->codigo +1 : 1;
        }
    }
}
